...
const AboutView: React.FC = () => {
  ...
  return (
    <div className="bg-[#111] min-h-screen relative overflow-x-hidden font-sans text-white">
      ...
      {/* --- HERO SECTION --- */}
      <section className="relative z-10 min-h-screen flex items-center justify-center bg-white overflow-hidden">
        {/* Blob Background */}
        <FluidBackground />
      ...
      <section className="py-24 md:py-32 bg-[#F8F8F8] overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="mb-20">
            ...
            <h2 ref={textRef} className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8 leading-tight break-keep text-gray-300"> 
              <span>
